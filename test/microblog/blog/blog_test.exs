defmodule Microblog.BlogTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{post: "some post", user_id: "some user_id"}
  ...
  describe "userfollows" do
    ...
    @valid_attrs %{follows_user_id: "some follows_user_id", user_id: "some user_id"}
    @update_attrs %{follows_user_id: "some updated follows_user_id", user_id: "some updated user_id"}
    @invalid_attrs %{follows_user_id: nil, user_id: nil}
    ...
    test "create_following/1 with valid data creates a following" do
      assert {:ok, %Following{} = following} = Blog.create_following(@valid_attrs)
      assert following.follows_user_id == "some follows_user_id"
      assert following.user_id == "some user_id"
    end
    ...
    test "update_following/2 with valid data updates the following" do
      ...
      assert {:ok, following} = Blog.update_following(following, @update_attrs)
      assert %Following{} = following
      assert following.follows_user_id == "some updated follows_user_id"
      assert following.user_id == "some updated user_id"
    end
